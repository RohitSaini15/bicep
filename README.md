# Setup
This repository is taken from the AWS Spark Data Lake example. The Dockerfile has been updated to add kainos certificates and the pipeline has been modified to drop infrastructure integration tests as well as to be able to deploy the application stack standalone if needed. 

Below this is the original README from https://github.com/awslabs/data-solutions-framework-on-aws/blob/main/examples/spark-data-lake/README.md
