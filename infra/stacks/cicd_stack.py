...
class CICDPipelineStack(Stack):
    def __init__(self, scope: Construct, id: str, **kwargs) -> None:
        ...
        dsf.processing.SparkEmrCICDPipeline(
            ...
            #     )
            # ],
            source= CodePipelineSource.connection("KainosSoftwareLtd/agentic-ai-data-migration", "main",
                connection_arn="arn:aws:codeconnections:eu-north-1:933822101509:connection/f3adab6d-8b70-4279-83b4-2d9722977347"
            ),
